...
function buildIndexBody(endpoints) {
  const body = {
    _links: Object.values(endpoints).reduce((accumulator, endpoint) => {
      ...
      if (typeof createFunction === 'function' || typeof listFunction === 'function') {
      ...
      if (typeof lookupFunction === 'function' || typeof readFunction === 'function' || typeof updateFunction === 'function' || typeof deleteFunction === 'function') {
